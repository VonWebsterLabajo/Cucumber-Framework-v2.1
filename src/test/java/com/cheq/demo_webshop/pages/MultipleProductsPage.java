...
public class MultipleProductsPage {
    ...
    // Locators
    private By SEARCH_TXT = By.id("small-searchterms");
    private By SEARCH_BTN = By.xpath("//input[@value='Search']");
    private By CART_LNK = By.xpath("//span[@class='cart-label']");


    public void searchForProduct(String keyword) {
    	elementActionUtils.inputElement(SEARCH_TXT, keyword);
    }

    public void clickSearchButton() {
    	elementActionUtils.clickElement(SEARCH_BTN);
    }
    ...
    public void clickShoppingCart() {
        elementActionUtils.clickElement(CART_LNK);
    }
